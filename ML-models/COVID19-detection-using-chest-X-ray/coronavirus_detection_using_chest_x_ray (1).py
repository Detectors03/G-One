...
Original file is located at
    https://colab.research.google.com/drive/1L8xV280KxHUSKdETfEiBAhBl5Y1jVhaR
"""
...
model.save('/content/gdrive/My Drive/Data/Covid_model.h5')

#importing modules and funtion that will be require to load model
...
#code to load model
model = tf.keras.models.load_model('/content/gdrive/My Drive/Data/Covid_model.h5')  #loading model
